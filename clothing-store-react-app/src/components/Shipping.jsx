...
const Shipping = ({ ship, setShip, dest, setDest }) => {
    ...
    return (<div className='flex flex-col justify-items-start'>
        <div className='flex'>
            <select className='flex flex-row w-28.5' value={ship} onChange={(e) => setShip(e.target.value)} disabled={cart.length == 0}>
        ...
        <div>
            <select value={dest} onChange={(e) => setShip(e.target.value)} disabled={cart.length == 0}>
